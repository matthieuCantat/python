...
import python
from python.classe.mayaClasse import *
...
class mayaClasse():
	...
	def __init__(self , **args ):
		...
		self.utilsClasseInfoAttr               = 'classeInfoAttr'	
	...
	def utils_dictionaryToMayaObjInfo( self ,  obj  , dictionary ):
		...
		#INIT		
		dictValues = {}		
		if not( mc.objExists(obj) ) or not( mc.nodeType(obj) == 'transform' ):
				return 0
		#DELETE
	...
	def utils_dictToMayaClasse( self , dict ):
		#print('utils_dictToMayaClasse...')
		#INIT INSTANCE
		classeType = dict['classeType']
		#print( 'CREATE INSTANCE OF TYPE : {}'.format(classeType) )
	...
	def utils_mayaClasseToDict( self , classeInstance ):
		...
		while not( len(attributes) == 0 ):
			...
			for i in range( 0 , len(attributes) ):
				...
				#print( i , attributes[i] , attrValue , attrType )
