...
def getOrientedBoundingBoxCoords( coords ):
...
class getOrientedBoundingBox(ommpx.MPxCommand):
	...
	kPluginCmdName = 'getReelBBCoordsCmds'
	...
	def doIt(self, args):
		...
		rotatedBBCoords = getOrientedBoundingBoxCoords( coords ) 
...
def initializePlugin(obj):
	...
	try:
		plugin.registerCommand( getOrientedBoundingBox.kPluginCmdName , getOrientedBoundingBox.cmdCreator)
...
def uninitializePlugin(obj):
	...
	try:
		plugin.deregisterCommand( getOrientedBoundingBox.kPluginCmdName  )
