...
class ctrlVisibilityNode(ommpx.MPxNode):
    ...
    def compute( self, plug , dataBlock ):
		...
		for i in range( arrayDataHandle.elementCount() ): 
			...
			matrixBBMaster.append( dataHandle.asFloatMatrix() )		
			
		timeGetEval.append( time.clock() )		
		
		#_3___ BB Matrix Slave 8    ------------------ INIT       
		...
		timediffGet    = []
		timediffGet.append( timeGetEval[0] - timeGetEval[1] )
		timediffGet.append( timeGetEval[1] - timeGetEval[2] )
		timediffGet.append( timeGetEval[2] - timeGetEval[3] )
		timediffGet.append( timeGetEval[0] - timeGetEval[3] )
		...
		print('                 getAttr  master M     : %f , %f /100 '%( timediffGet[0] , timediffGet[0] / timediffGet[3] * 100) )
		print('                 getAttr  master BB    : %f , %f /100 '%( timediffGet[1] , timediffGet[1] / timediffGet[3] * 100) )		
		print('                 getAttr  slave Coords : %f , %f /100 '%( timediffGet[2] , timediffGet[2] / timediffGet[3] * 100) )
		print('                 getAttr  total        : %f , %f /100 '%( timediffGet[3] , timediffGet[3] / timediffGet[3] * 100) )
