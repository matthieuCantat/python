...
version 2 les slaves ne bouge pas
    ...
    def compute( self, plug , dataBlock ):
		...
		for i in range( arrayDataHandle.elementCount() ):  
			...
			if( (i % nbrBBPoint) == 0 ) and not ( i == 0 ) :
				BBSlavesCoords.append( BBSlavesCoordsTMP )
				BBSlavesCoordsTMP = []
			
			dataHandle = arrayDataHandle.inputValue()			
			BBSlavesCoordsTMP.append( dataHandle.asFloat3() )
		...
		for i in range( 0 , len( BBSlavesCoords ) ) :
			
			isIn = 0				
			for p in range( 0 , nbrBBPoint  ):
		
				upCurrent = om.MVector( ( BBSlavesCoords[i][p][0] - manipMasterCoords[0][0] ) , ( BBSlavesCoords[i][p][1] - manipMasterCoords[0][1] ) , ( BBSlavesCoords[i][p][2] - manipMasterCoords[0][2] ) )     
				dnCurrent = om.MVector( ( BBSlavesCoords[i][p][0] - manipMasterCoords[6][0] ) , ( BBSlavesCoords[i][p][1] - manipMasterCoords[6][1] ) , ( BBSlavesCoords[i][p][2] - manipMasterCoords[6][2] ) )      
