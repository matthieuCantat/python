...
class dynamicRotation(ommpx.MPxNode):
    ...
    kPluginNodeTypeName = 'dynamicRotationLimitesNode'
    ...
    input2Attr = None
    kInput2AttrName = 'inMatrix'
    kInput2AttrLongName = 'inMatrix'   
    ...
    input8Attr = None
    kInput8AttrName = 'mins'
    kInput8AttrLongName = 'minValues'    
  
    input9Attr = None
    kInput9AttrName = 'maxs'
    kInput9AttrLongName = 'maxValues'     

    input10Attr = None
    kInput10AttrName = 'distance'
    kInput10AttrLongName = 'distance'        
    ...
    input16Attr = None
    kInput16AttrName = 'ctrlTranslate'
    kInput16AttrLongName = 'ctrlTranslate' 

    input17Attr = None
    kInput17AttrName = 'ctrlRotate'
    kInput17AttrLongName = 'ctrlRotate' 

    input18Attr = None
    kInput18AttrName = 'ctrlScale'
    kInput18AttrLongName = 'ctrlScale' 
    
    input19Attr = None
    kInput19AttrName = 'follow'
    kInput19AttrLongName = 'follow' 
    ...
    outputX = None
    kOutputXAttrName = 'outRotX'
    kOutputXAttrLongName = 'outRotationX'
    
    outputY = None
    kOutputYAttrName = 'outRotY'
    kOutputYAttrLongName = 'outRotationY'
 
    outputZ = None
    kOutputZAttrName = 'outRotZ'
    kOutputZAttrLongName = 'outRotationZ'    
    ...
    def compute( self, plug , dataBlock ):
        ...
        mc.setAttr( nodeName +'.'+ self.kInput13AttrName  ,  self.lastSpeed[0] ,  self.lastSpeed[1] ,  self.lastSpeed[2] , type = 'double3')            
        mc.setAttr( nodeName +'.'+ self.kInput14AttrName  , self.slaveValue[0] , self.slaveValue[1] , self.slaveValue[2] , type = 'double3')                        
        mc.undoInfo( swf = 1 )
    ...
    def nodeInitializer(cls):
        ...
        cls.input13Attr = nAttr.create(cls.kInput13AttrLongName, cls.kInput13AttrName , om.MFnNumericData.k3Float  )
        nAttr.setKeyable(True)       
        nAttr.setReadable(False)  

        nAttr = om.MFnNumericAttribute()   
        
        cls.input14Attr = nAttr.create(cls.kInput14AttrLongName, cls.kInput14AttrName , om.MFnNumericData.k3Float  )
        nAttr.setKeyable(True)       
        nAttr.setReadable(False)  
        ...
        cls.input16Attr = nAttr.create(cls.kInput16AttrLongName, cls.kInput16AttrName , om.MFnNumericData.k3Float  )
        nAttr.setKeyable(True)       
        nAttr.setReadable(False) 

        nAttr = om.MFnNumericAttribute()   
        
        cls.input17Attr = nAttr.create(cls.kInput17AttrLongName, cls.kInput17AttrName , om.MFnNumericData.k3Float  )
        nAttr.setKeyable(True)       
        nAttr.setReadable(False) 

        nAttr = om.MFnNumericAttribute()   
        
        cls.input18Attr = nAttr.create(cls.kInput18AttrLongName, cls.kInput18AttrName , om.MFnNumericData.k3Float  )
        nAttr.setKeyable(True)       
        nAttr.setReadable(False)         

        nAttr = om.MFnNumericAttribute()   
        
        cls.input19Attr = nAttr.create(cls.kInput19AttrLongName, cls.kInput19AttrName , om.MFnNumericData.kFloat  )
        nAttr.setKeyable(True)       
        nAttr.setReadable(False)    
        ...
        cls.outputXAttr = nAttr.create(cls.kOutputXAttrLongName, cls.kOutputXAttrName, om.MFnNumericData.kFloat )
        nAttr.setWritable(False)
        nAttr.setStorable(False)
        
        nAttr = om.MFnNumericAttribute() 
        
        cls.outputYAttr = nAttr.create(cls.kOutputYAttrLongName, cls.kOutputYAttrName, om.MFnNumericData.kFloat )
        nAttr.setWritable(False)
        nAttr.setStorable(False)
        
        nAttr = om.MFnNumericAttribute() 
        
        cls.outputZAttr = nAttr.create(cls.kOutputZAttrLongName, cls.kOutputZAttrName, om.MFnNumericData.kFloat )
        nAttr.setWritable(False)
        nAttr.setStorable(False)             
