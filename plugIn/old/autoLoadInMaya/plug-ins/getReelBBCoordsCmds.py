...
class getReelBBCoordsCmds(ommpx.MPxCommand):
...
def initializePlugin(obj):
	...
	try:
		plugin.registerCommand( getReelBBCoordsCmds.kPluginCmdName , getReelBBCoordsCmds.cmdCreator)
...
def uninitializePlugin(obj):
	...
	try:
		plugin.deregisterCommand( getReelBBCoordsCmds.kPluginCmdName  )
