...
mc.parentConstraint( "body0_JNT" , "render_CAM" , mo = True )
mc.parentConstraint( "body0_JNT" , "rim_LIGHT" , mo = True )
...
rwi.mayaScene_save( 'D:/mcantat_BDD/projects/cute/assets/camera/maya/scenes/camera_rigBoundB.ma' )
#___________________________________________________________________________SAVE TO SKELETON